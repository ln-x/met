...
ax1.plot(vpd_dmax_w[MAM20_s:MAM20_e2], linewidth="1", color='green', label="VPD")#, label="vpd,dmax,w")
ax1.plot(vpd_dmax_w[MAM20_s:MAM20_e2].index, vpd_dmax_w[MAM18_s:MAM18_e2].values, linewidth="1", color='green', linestyle=":")
ax1.fill_between(vpd_dmax_w[MAM20_s:MAM20_e2].index, vpd_dmax_w[MAM20_s:MAM20_e2].values.flatten()+vpd_dmax_sigma,vpd_dmax_w[MAM20_s:MAM20_e2].values.flatten()-vpd_dmax_sigma, facecolor='green', alpha=0.1)
ax1.fill_between(vpd_dmax_w[MAM20_s:MAM20_e2].index, vpd_dmax_w[MAM18_s:MAM18_e2].values.flatten()+vpd_dmax_sigma,vpd_dmax_w[MAM18_s:MAM18_e2].values.flatten()-vpd_dmax_sigma, facecolor='grey', alpha=0.1)
ax1.set_xlim(start,end)
ax1.xaxis.set_major_formatter(mdates.DateFormatter(' '))
...
ax1 = plt.gca()
#ax1.axhline(0, color='grey',linestyle="dashed",linewidth="0.3")
ax1.plot((BOKUMetData_weekly["AT"][MAM20_s:MAM20_e2]), linewidth="1", color='red', label="AT") #label="GR,sum,w"
ax1.plot(BOKUMetData_weekly["AT"][MAM20_s:MAM20_e2].index,BOKUMetData_weekly["AT"][MAM18_s:MAM18_e2].values, linewidth="1", color='red', linestyle=":")
ax1.fill_between(BOKUMetData_weekly["AT"][MAM20_s:MAM20_e2].index, BOKUMetData_weekly["AT"][MAM20_s:MAM20_e2].values.flatten()+tmax_sigma,BOKUMetData_weekly["AT"][MAM20_s:MAM20_e2].values.flatten()-tmax_sigma, facecolor='red', alpha=0.1)
ax1.fill_between(BOKUMetData_weekly["AT"][MAM20_s:MAM20_e2].index, BOKUMetData_weekly["AT"][MAM18_s:MAM18_e2].values.flatten()+tmax_sigma,BOKUMetData_weekly["AT"][MAM18_s:MAM18_e2].values.flatten()-tmax_sigma, facecolor='grey', alpha=0.1)
ax1.set_xlim(start,end)
...
ax1 = plt.gca()
#ax1.axhline(0, color='grey',linestyle="dashed",linewidth="0.3")
ax1.plot(hcho_w[MAM20_s:MAM20_e2], linewidth="1", color='black',label="HCHO")#, label="HCHO,dmax,w", linestyle="solid")
ax1.plot(hcho_w[MAM20_s:MAM20_e2].index,hcho_w[MAM18_s:MAM18_e2].values, linewidth="1", color='black', linestyle=":")
ax1.fill_between(hcho_w[MAM20_s:MAM20_e2].index, hcho_w[MAM20_s:MAM20_e2].values.flatten()+hcho_sigma,hcho_w[MAM20_s:MAM20_e2].values.flatten()-hcho_sigma, facecolor='black', alpha=0.1)
ax1.fill_between(hcho_w[MAM20_s:MAM20_e2].index, hcho_w[MAM18_s:MAM18_e2].values.flatten()+hcho_sigma,hcho_w[MAM18_s:MAM18_e2].values.flatten()-hcho_sigma, facecolor='grey', alpha=0.1)
ax1.set_xlim(start,end)
#ax2.axvline(x=datetime(2020,5,10))
