...
gr = BOKUMetData_dailymax["GR"][start:end]/1000
gr_sigma = gr.std()
...
ax2.plot(o3_1990_2020_mda8['AT9STEF'][start:end],linewidth="1", color='violet', linestyle="solid") #label="o3 OBS mda8",
ax1.fill_between(gr.index, gr.values+gr_sigma,gr.values-gr_sigma, facecolor='orange', alpha=0.1)
ax2.fill_between(o3_1990_2020_mda8['AT9STEF'][start:end].index, o3_1990_2020_mda8['AT9STEF'][start:end].values+o3_sigma,o3_1990_2020_mda8['AT9STEF'][start:end].values-o3_sigma, facecolor='violet', alpha=0.1)
...
ax1.plot(tsif,color='violet', label="TROP")
ax1.plot(osif_757,color='red',label="OCO-2")
...
ax2.plot(BOKUMetData_dailymax["AT"][start:end], linewidth="1", color='red')#, label="vpd dmax")
ax2.fill_between(BOKUMetData_dailymax["AT"][start:end][start:end].index, BOKUMetData_dailymax["AT"][start:end].values+vpd_sigma,BOKUMetData_dailymax["AT"][start:end].values-vpd_sigma, facecolor='black', alpha=0.1)
...
ax1.set_xlim(start,end)
ax2.set_ylabel("AT_max[°C]", size="medium", color="green")
