...
print("HCHOmean NW/VP:", pffNW_veg['hcho'].mean(), "NW/NVP:", pffNW_noveg['hcho'].mean(), "SE/VP:",pffSE_veg['hcho'].mean(), "SE/NVP:", pffSE_noveg['hcho'].mean())
