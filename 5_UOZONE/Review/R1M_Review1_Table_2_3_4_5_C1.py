...
foldername_K = "/Users/lnx/DATA/remote/ground/maxdoas/MAXDOAS_KQ"
...
BOKUMetData = BOKUMet_Data.BOKUMet() #10min values
...
file_pbl = "/Users/lnx/DATA/obs_point/met/ZAMG/Ceilometer/MH_Wien_Hohe_Warte_20170101_20201231.csv"
...
def Plot6var(df,title,ylimit):
    ...
    SRho_GRO3, Sp_GRO3 = (stats.spearmanr(x5_GR[idxO3], x5_O3[idxO3]))
    #SRho_SIF, Sp_GRO3 = (stats.spearmanr(x5_GR[idxGR], x5_O3[idxGR]))
    ...
    print("Spearman Rho:", "GR-O3", f'{SRho_GRO3:.2f}', title)  
...
pff_2018 = pff_full[datetime(2018, 3, 1, 00, 00):datetime(2018, 8, 31, 00, 00)].resample('D').mean()
pff_2019 = pff_full[datetime(2019, 3, 1, 00, 00):datetime(2019, 8, 31, 00, 00)].resample('D').mean()
pff_2020 = pff_full[datetime(2020, 3, 1, 00, 00):datetime(2020, 8, 31, 00, 00)].resample('D').mean()

title="full"
Plot6var(pff_full,title, ylimit=8)

title = "2018"
Plot6var(pff_2018,title, ylimit=8)
title = "2019"
Plot6var(pff_2019,title, ylimit=8)
title = "2020"
Plot6var(pff_2020,title, ylimit=8)
