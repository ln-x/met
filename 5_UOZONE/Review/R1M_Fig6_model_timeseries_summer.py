...
ax1.plot(LAIJJA19["VAR"], linewidth="1", color='green', linestyle=":", label="LAI_ww")
ax1.plot(LAIJJA19["VAR"].index, LAIJJA20["VAR"].values, linewidth="1", color='green')
...
ax1.plot(WGJJA19["VAR"], linewidth="1", color='green', label="SM_ww") 
ax1.plot(WGJJA19["VAR"].index, WGJJA20["VAR"].values, linewidth="1", color='green', linestyle=":")
...
ax1.set_title('(b)', loc='left', size='medium')
ax1.plot(ISOJJA19["VAR"], linewidth="1", color='green', label="ISO_ww") 
ax1.plot(ISOJJA19["VAR"].index, ISOJJA20["VAR"].values, linewidth="1", color='green', linestyle=":")
