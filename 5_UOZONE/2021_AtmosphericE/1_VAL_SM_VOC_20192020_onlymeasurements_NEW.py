...
SE4_s = datetime(2017, 7, 29, 00, 00)
SE4_e = datetime(2017, 8, 2, 00, 00)

NW1_s = datetime(2019, 3, 24, 00, 00)
...
#ax2.plot(o3_1990_2020_mda8_w['AT9STEF'][start:end]*ugm3toppb_o3,linewidth="1", color='violet', label="o3 OBS mda8", linestyle="solid")
...
ax1.plot(BOKUMetData_weekly["GR"][start:end], linewidth="1", color='orange', label="GR sum BOKUR")
...
#ax1.set_ylim(-5, 35)
#ax1.axvspan(SE1_s, SE1_e, color='red', alpha=0.2)
#ax1.axvspan(SE2_s, SE2_e, color='red', alpha=0.2)
#ax1.axvspan(SE3_s, SE3_e, color='red', alpha=0.2)
#ax1.axvspan(SE4_s, SE4_e, color='red', alpha=0.2)
...
ax2.plot(vpd_dmax_w[start:end], linewidth="1", color='lightsalmon', label="vpd dmax")
