...
plt.title("grass, 40-100 cm")
ax1 = plt.subplot(gs[0])
ax2 = plt.subplot(gs[1])
ax1.plot(range(len(rss_sub18)), rss_sub18["RSS_sub_grass"], color='blue',label="2018", linewidth=1)
ax1.plot(range(len(rss_sub19)), rss_sub19["RSS_sub_grass"], color='green',label="2019", linewidth=1)
ax1.plot(range(len(rss_sub20)), rss_sub20["RSS_sub_grass"], color='orange',label="2020", linewidth=1)
ax1.plot(range(365),mean12yr_d_noleap['RSS_sub_grass'].values,color='grey',label="2008-2020",linewidth=2)
