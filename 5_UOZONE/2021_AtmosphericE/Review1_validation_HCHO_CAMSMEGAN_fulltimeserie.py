...
Emis_ol_noontime_full = Emis_ol_noontime.append(Emis_ol_noontime20)
Emis_assim_noontime_full = Emis_assim_noontime.append(Emis_assim_noontime20)
...
def Plot6var(df1, df2, df3, title):
    Emis_JJA2019_as = df1[datetime.datetime(2019, 1, 1, 00, 00): datetime.datetime(2020, 12, 31, 00, 00)].values.flatten()
    Emis_JJA2019_ol3 = df2[datetime.datetime(2019, 1, 1, 00, 00): datetime.datetime(2020, 12, 31, 00, 00)].values.flatten()
    hcho_JJA2019 = df3[datetime.datetime(2019, 1, 1, 00, 00): datetime.datetime(2020, 12, 31, 00, 00)].values.flatten()
...
Plot6var(Emis_ol_noontime_veg, Emis_assim_noontime_veg, hcho_d_veg,"noon time mean (9-15), spring+summer March-August")
