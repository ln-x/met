...
x1 = plt.gca()
ax2 = ax1.twinx()
ax2.plot(o3_1990_2020_mda8_w['AT9STEF'][JJA19_s:JJA19_e2],linewidth="1", color='violet', linestyle="solid",label="O3_dry") #label="O3,mda8,w",
ax2.plot(o3_1990_2020_mda8_w['AT9STEF'][JJA19_s:JJA19_e2].index, o3_1990_2020_mda8_w['AT9STEF'][JJA20_s:datetime(2020, 9, 7)].values,linewidth="1", color='violet', linestyle=":", label="O3_reg")
ax1.plot((BOKUMetData_weekly["GR"][JJA19_s:JJA19_e2])/1000, linewidth="1", color='orange', label="GR_dry") #label="GR,sum,w"
ax1.plot(BOKUMetData_weekly["GR"][JJA19_s:JJA19_e2].index,BOKUMetData_weekly["GR"][JJA20_s:JJA20_e2].values/1000, linewidth="1", color='orange', linestyle=":", label="GR_reg")
...
ax1 = plt.gca()
ax2 = ax1.twinx()
ax1.plot(tsif_w,color='violet', label="SIF_dry") #label="SIF_w"
ax1.plot(tsif_w[datetime(2019, 6, 1):datetime(2019, 8, 31)].index, tsif_w[datetime(2020, 6, 1):datetime(2020, 9, 1)].values, color='violet',linestyle=":", label="SIF_reg")#,label="OCO-2 SIF")
ax1.set_ylabel("[mW/m2/sr/nm]", size="medium")
ax2.plot(fAPAR[datetime(2019, 6, 1):datetime(2019, 9, 1)],color='green', label="fAPARa_dry")#label="fAPAR anomaly"
ax2.plot(fAPAR[datetime(2019, 6, 1):datetime(2019, 9, 1)].index, fAPAR[datetime(2020, 6, 1):datetime(2020, 9, 1)].values,color='green', linestyle=":", label="fAPARa_reg")
...
ax1 = plt.gca()
ax2 = ax1.twinx()
ax1.plot(vwc['RSS_sub_wWheat'][JJA19_s:JJA19_e],linewidth="1", color='orange', linestyle="solid", label="RSS_w_dry") #label="RSS_sub_w",
ax1.plot(vwc['RSS_sub_wWheat'][JJA19_s:JJA19_e].index,vwc['RSS_sub_wWheat'][JJA20_s:JJA20_e].values,linewidth="1", color='orange', linestyle=":", label="RSS_w_reg") #label="RSS_sub_w",
ax1.plot(vwc['RSS_sub_grass'][JJA19_s:JJA19_e],linewidth="1", color='green', linestyle="solid", label="RSS_g_dry") #label="RSS_sub_g"
ax1.plot(vwc['RSS_sub_grass'][JJA19_s:JJA19_e].index,vwc['RSS_sub_grass'][JJA20_s:JJA20_e].values,linewidth="1", color='green', linestyle=":", label="RSS_g_reg")
ax2.step(BOKUMetData_dailysum[JJA19_s:JJA19_e].index,(BOKUMetData_dailysum["PC"]*0.1)[JJA19_s:JJA19_e], linewidth="0.3", color='blue', label="PR_dry") #{'pre', 'post', 'mid'} label="PR,sum"
ax2.step(BOKUMetData_dailysum[JJA19_s:JJA19_e].index,(BOKUMetData_dailysum["PC"]*0.1)[JJA20_s:JJA20_e].values, linewidth="0.3", color='blue', linestyle=":", label="PR_reg") #{'pre', 'post', 'mid'}  label="PR,sum",
...
ax2.plot(vpd_dmax_w[JJA19_s:datetime(2019, 9, 7)], linewidth="1", color='green', label="VPD_dry")#, label="vpd,dmax,w")
#ax2.plot(vpd_dmax[JJA19_s:datetime(2019, 9, 1)].index, vpd_dmax[JJA20_s:datetime(2020, 9, 1)].values, linewidth="0.3", color='green', linestyle=":")
ax2.plot(vpd_dmax_w[JJA19_s:datetime(2019, 9, 7)].index, vpd_dmax_w[JJA20_s:datetime(2020, 9, 7)].values, linewidth="1", color='green', linestyle=":", label="VPD_reg")
#ax1.plot(hcho_d[JJA19_s:JJA19_e], linewidth="0.3", color='black')#, label="HCHO") #,dmax", linestyle="solid")
ax1.plot(hcho_w[JJA19_s:datetime(2019, 9, 7)], linewidth="1", color='black',label="HCHO_dry")#, label="HCHO,dmax,w", linestyle="solid")
#ax1.plot(hcho_d[JJA19_s:datetime(2019, 9, 1)].index,hcho_d[JJA20_s:datetime(2020, 9, 1)].values, linewidth="0.3", color='black', linestyle=":")
ax1.plot(hcho_w[JJA19_s:datetime(2019, 9, 7)].index,hcho_w[JJA20_s:datetime(2020, 9, 7)].values, linewidth="1", color='black', linestyle=":", label="HCHO_reg")
ax1.set_xlim(JJA19_s,JJA19_e)
...
#ax1.axhline(0, color='grey',linestyle="dashed",linewidth="0.3")
#ax2.plot(vpd_dmax[JJA19_s:JJA19_e], linewidth="0.3", color='green', label="VDP") #vpd,dmax")
#ax2.plot((BOKUMetData_dailymax["AT"][JJA19_s:JJA19_e]), linewidth="0.3", color='red')#, label="AT") #label="GR,sum,w"
ax2.plot((BOKUMetData_weekly["AT"][JJA19_s:JJA19_e2]), linewidth="1", color='red', label="Tair_dry") #label="GR,sum,w"
#ax2.plot(BOKUMetData_dailysum["AT"][JJA19_s:JJA19_e].index,BOKUMetData_dailymax["AT"][JJA20_s:JJA20_e].values, linewidth="0.3", color='red', linestyle=":")
ax2.plot(BOKUMetData_weekly["AT"][JJA19_s:JJA19_e2].index,BOKUMetData_weekly["AT"][JJA20_s:JJA20_e2].values, linewidth="1", color='red', linestyle=":", label="Tair_reg")
#ax1.plot(hcho_d[JJA19_s:JJA19_e], linewidth="0.3", color='black')#, label="HCHO") #,dmax", linestyle="solid")
ax1.plot(hcho_w[JJA19_s:datetime(2019, 9, 7)], linewidth="1", color='black',label="HCHO_dry")#, label="HCHO,dmax,w", linestyle="solid")
#ax1.plot(hcho_d[JJA19_s:datetime(2019, 9, 1)].index,hcho_d[JJA20_s:datetime(2020, 9, 1)].values, linewidth="0.3", color='black', linestyle=":")
ax1.plot(hcho_w[JJA19_s:datetime(2019, 9, 7)].index,hcho_w[JJA20_s:datetime(2020, 9, 7)].values, linewidth="1", color='black', linestyle=":", label="HCHO_reg")
