...
def Plot6var(df,title,ylimit):
    ...
    ax1.set_xlabel(r"GR [$kWhm⁻²$]", size="medium")
    ...
    ax4.scatter(x5_VPD[a:], y5[a:],  color='grey',s=5)
    ax4.plot(x5_VPD, m5VPD * x5_VPD + b5VPD, color='black')
    ax4.set_xlabel("VPD [kPa]", size="medium")
    ...
    ax5.set_xlabel("O3 [μg/m³]", size="medium")
