...
"""
wrf_STE_i =  #16.3742 48.2086      
wrf_STE_j =
wrf_LOB_i =  #16.5269 48.1625
wrf_LOB_j =
wrf_HER_i =  #16.2983 48.2708
wrf_HER_j =
"""
...
ax1.plot(o3_1990_2020_mda1_w['AT9JAEG'],linewidth="1", color='purple', label="JAEG", linestyle="-") #TODO mda1 vs da (mda8)
ax1.plot(o3_1990_2020_mda1_w['AT9STEF'],linewidth="1", color='violet', label="STEF", linestyle="-") #mda1 vs da (mda8)
ax1.plot(o3_1990_2020_mda1_w['AT90LOB'],linewidth="1", color='blue', label="LOB", linestyle="-") #mda1 vs da (mda8)
ax3 = fig.add_subplot(3, 1, (3, 3))#, sharex=True)
ax3.plot(emep_o3_d,color='black') #(time, j, i)
ax1.set_ylim(0, 150)
ax3.set_ylim(0, 150)
plt.ylabel("[ug/m2]", size="medium")
...
ax1.scatter(emep_o3_d[start:end].values,o3_1990_2020_mda1['AT9JAEG'][start:end].values,label="JAEG")
ax2.scatter(emep_o3_d[start:end].values,o3_1990_2020_mda1['AT9STEF'][start:end].values,label="STEF")
ax3.scatter(emep_o3_d[start:end].values,o3_1990_2020_mda1['AT90LOB'][start:end].values,label="LOB")
