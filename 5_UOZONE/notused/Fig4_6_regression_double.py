...
def Plot6var(df1, df2, title, ylimit):
    ...
    axs[0, 0].set_title('p_black={:.2f} \n p_red={:.2f}'.format(Sp_AT, Sp_AT_2), fontsize='small')
    ...
    axs[0, 1].set_title('p_black={:.2f} \n p_red={:.2f}'.format(Sp_GR, Sp_GR_2), fontsize='small')
    ...
    axs[0, 2].set_title('p_black={:.2f} \n p_red={:.2f}'.format(Sp_O3, Sp_O3_2), fontsize='small')
    ...
    axs[1, 0].set_title('p_black={:.2f} \n p_red={:.2f}'.format(Sp_SM, Sp_SM_2), fontsize='small')
    ...
    axs[1, 2].set_title('p_black={:.2f} \n p_red={:.2f}'.format(Sp_VPD, Sp_VPD_2), fontsize='small')
...
pff_A20 = pff_full[datetime(2020, 7, 1, 00, 00):datetime(2020, 8, 31, 00, 00)].resample('D').mean()
pff_A19 = pff_full[datetime(2019, 7, 1, 00, 00):datetime(2019, 8, 31, 00, 00)].resample('D').mean()

Plot6var(pff_M18,pff_M20,"May, 18 (black), 20 (red)", ylimit=8)
Plot6var(pff_A20,pff_A19,"Aug, 20 (black), 19 (red)", ylimit=8)
