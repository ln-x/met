...
ax.plot(x_s, a11_s, color='orange', lw=0.1, label='ext')
ax.plot(x_s, a4_s, color='green', lw=0.1, label='int.')
ax.plot(x_s, a2_s, color='blue', lw=0.1, label='foil')
ax.plot(x_s, a7_s, color='black', lw=0.1, label='tar')
ax.plot(x_s, a10_s, color='lightblue', lw=0.1, label='cobble')
plt.ylim(0, 0.4)
plt.xlabel('time')
plt.ylabel('albedo[%]')
plt.grid(True)
