...
filename = "/home/lnx/PycharmProjects/Messdatenauswertung/HStest/v808_20130411_c00_v01_f05/Heat_SR6.txt"
...
filename = "/home/lnx/PycharmProjects/Messdatenauswertung/HStest/v808_20130411_c00_v01_f30/Heat_SR6.txt"
...
filename = "/home/lnx/PycharmProjects/Messdatenauswertung/HStest/v808_20130411_c10_v01_f05/Heat_SR6.txt"
...
filename = "/home/lnx/PycharmProjects/Messdatenauswertung/HStest/v808_20130411_c10_v01_f30/Heat_SR6.txt"
...
plt.ylabel('received solar radiation[Wm-2], cloudiness = 0%')
#plt.ylim(-15,15)
...
ax.plot(date_time, d1, color='red', lw=0.5, label='0.65km')
ax.plot(date_time, d2, color='darkred', lw=0.5, label='040 km')
ax.plot(date_time, d3, color='violet', lw=0.5, label='0.15km')
ax.plot(date_time, d4, color='darkblue', lw=0.5, label='0.00km')
# plt.axis([1, 23, 5, 20])
# plt.setp(plt.gca(), xticklabels=[6, 12, 18], yticks=(10, 15, 20), xticks=(6, 12, 18))
