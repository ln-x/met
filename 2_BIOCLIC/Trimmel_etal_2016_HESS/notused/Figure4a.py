...
WT = pd.read_csv('/home/lnx/PycharmProjects/HS/298_P500_STQ_2013_p/outputfiles_20130725_0809/Temp_H2O_360h.txt', skiprows=6, sep='\s+', index_col='Datetime') #, parse_dates="Datetime"
...
b= ax.plot(Rkm, WT_max, color='black', lw=0.9,  linestyle='dotted', label='2013_STQ_max')
...
e= ax.plot(Rkm, WT_2030_V0_mean, color='red', lw=0.9, label='V0')
f= ax.plot(Rkm, WT_2030_V0_max, color='red', lw=0.9, linestyle='dotted',  label='V0_max')
g= ax.plot(Rkm, WT_2030_V100_mean, color='green', lw=0.9, label='V100')
h= ax.plot(Rkm, WT_2030_V100_max, color='green', lw=0.9, linestyle='dotted', label='V100_max')
ax.set(xticklabels=('','','','',''))
...
ax.plot(Rkm, WT_max, color='black', lw=0.9,  linestyle='dotted', label='2013_STQ_max')
...
ax.plot(Rkm, WT_2050_V0_mean, color='red', lw=0.9, label='V0')
ax.plot(Rkm, WT_2050_V0_max, color='red', lw=0.9, linestyle='dotted',  label='V0_max')
ax.plot(Rkm, WT_2050_V100_mean, color='green', lw=0.9, label='V100')
ax.plot(Rkm, WT_2050_V100_max, color='green', lw=0.9, linestyle='dotted', label='V100_max')
ax.set(xticklabels=('','','','',''))
#plt.legend(loc=9, ncol=4, fontsize='small')
plt.ylabel('water temperature [degC]')
...
ax.plot(Rkm, WT_max, color='black', lw=0.9,  linestyle='dotted')
ax.plot(Rkm, WT_max_2085_mean, color='orange', lw=0.9)
ax.plot(Rkm, WT_max_2085_V0_mean, color='red', lw=0.9)
ax.plot(Rkm, WT_max_2085_V100_mean, color='green', lw=0.9)
ax.plot(Rkm, WT_max_2085_max, color='orange', lw=0.9, linestyle='dotted')
ax.plot(Rkm, WT_max_2085_V0_max, color='red', lw=0.9, linestyle='dotted')
ax.plot(Rkm, WT_max_2085_V100_max, color='green', lw=0.9, linestyle='dotted')
ax.set(xticklabels=('','','','',''))
#plt.ylabel('water temperature [degC]')

ax = fig.add_subplot(414)
ax.set_title('green: STQ-V100, red: STQ-V0*-1', fontsize='small', loc='left') #, color='g'
axisrange = [12,60,-0.1,2.5]
plt.axis(axisrange)
ax.plot(Rkm, WT_2030_V100_diff, color='green', lw=0.9, label='2030')#: STQ-V100')
ax.plot(Rkm, WT_2050_V100_diff, color='green', lw=0.9, linestyle='dashed',label='2050') #: STQ-V100')
ax.plot(Rkm, WT_2085_V100_diff, color='green', lw=0.9,linestyle='dotted', label='2085') #: STQ-V100')
ax.plot(Rkm, WT_2030_V0_diff, color='red', lw=0.9)#, label='2030: STQ-V0 *-1')
ax.plot(Rkm, WT_2050_V0_diff, color='red', lw=0.9, linestyle='dashed')#,label='2050: STQ-V0 *-1')
ax.plot(Rkm, WT_2085_V0_diff, color='red', lw=0.9, linestyle='dotted')#, label='2085: STQ-V0 *-1')
