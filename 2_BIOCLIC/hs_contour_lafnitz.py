...
#filename = "/home/lnx/PycharmProjects/HS/048_L500_inklhourlyinflows/outputfiles/Heat_Conv.txt"
filename = "/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Simulations_Archive/048_L_clean/outputfiles/Heat_Conv.txt"
...
y = [i for i in range(1, 1393, 1)]                                     #1392 hours from 3 July 0h - 29 August 2013 23h
#y = [i for i in range(1, 1321, 1)]                                     #1320 hours from 1 July 0h - 24 August 2013 23h
print y
...
#x = [93,92.5,92,91.5,91,90.5,90,89.5,89,88.5,88,87.5,87,86.5,86,85.5,85,84.5,84,83.5,83,82.5,82,81.5,81,80.5,80,79.5,79,78.5,78,77.5,77,76.5,76,75.5,
x = [96,95.5,95,94.5,94,93.5,93,92.5,92,91.5,91,90.5,90,89.5,89,88.5,88,87.5,87,86.5,86,85.5,85,84.5,84,83.5,83,82.5,82,81.5,81,80.5,80,79.5,79,78.5,78,77.5,77,76.5,76,75.5,
...
#     19,18.5,18,17.5,17,16.5,16,15.5,15,14.5,14,13.5,13,12.5,12,11.5,11,10.5,10,9.5,9,8.5,8,7.5]
     19,18.5,18,17.5,17,16.5,16,15.5,15,14.5,14,13.5,13,12.5,12,11.5,11,10.5,10,9.5,9,8.5,8,7.5,7,6.5,6,5.5,5,4.5,4,3.5,3,2.5,2,1.5,1,0.5,0]
#x = np.arange[93, 7.5, 0.5]
...
#puredata = puredata[:1322]                  #schneidet am 24.August 2013 23h ab -> weil danach bei submitted version nur nan kommt :-(
...
print "min(Z)=", min, "max(Z)=", max, "delta=(min-max)/35=", delta
print "std(Z)=", std
...
subplot(122)
hist(listeddata)
plt.title('Convection[W/m2], 3Jul-29Aug2013, Lafnitz,(clean48, origC, penman)')
...
fig.savefig('/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Output_analysis/2014Paper/Lafnitz_conv_statistics.png')
...
plt.title('Convection[W/m2], 3Jul-29Aug2013, Lafnitz,(submitted, origC, penman)')
plt.xlabel('distance from upstream model boundary [km]')
plt.ylabel('time[h]')
#plt.legend()
fig.savefig('/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Output_analysis/2014Paper/Lafnitz48_conv_contour.png')
fig.savefig('/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Output_analysis/2014Paper/Lafnitz48_conv_contour.eps')
