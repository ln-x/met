...
S200ns_allwhite_iso = "/home/lnx/MODELS/SURFEX/2_source/SURFEX_TRUNK_4818/trunk/MY_RUN/KTEST/lnx/200_Can_allwhite_isolated/2017_170171NS/TCANYON.TXT"
S200wo_allwhite_iso = "/home/lnx/MODELS/SURFEX/2_source/SURFEX_TRUNK_4818/trunk/MY_RUN/KTEST/lnx/200_Can_allwhite_isolated/2017_170171WO/TCANYON.TXT"
...
#STQ
ax1.plot(timelist,S200WOvalues, label=r"$\alpha_{G}$:0,13;$\alpha_{W}$:0,20;$\alpha_{R}$:0,14 'STQ'", color="red")#,linestyle="dashed")
#ax1.plot(timelist,S200NSvalues, color="black",linestyle=":")
ax1.plot(timelist,S200WOisolatedvalues, label=r"$\alpha_{G}$:0,13;$\alpha_{W}$:0,20;$\alpha_{R}$:0,14, isoliert", color="red",linestyle="dashed")
#ax1.plot(timelist,S200NSisolatedvalues, color="red",linestyle=":")
#Heller Boden
ax1.plot(timelist,S201WOvalues, label=r"$\alpha_{G}$:0,56;$\alpha_{W}$:0,20;$\alpha_{R}$:0,14 'heller Boden'", color="orange")#,linestyle="dashed")
#ax1.plot(timelist,S201NSvalues, color="black",linestyle=":")
ax1.plot(timelist,S201WOisovalues, label=r"$\alpha_{G}$:0,56;$\alpha_{W}$:0,20;$\alpha_{R}$:0,14, isoliert", color="orange",linestyle="dashed")
