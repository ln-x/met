...
ax1.plot(timelist,S100values,label="Asphalt,Putz", color="orange")
ax1.plot(timelist,S102values, label="Asphalt,dunkle Fassade", color="red")
ax1.plot(timelist,S101values, label="Beton,Putz", color="turquoise")
ax1.plot(timelist,S103values, label="Beton,Beton", color="blue")
