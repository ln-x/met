...
file2 = '/home/lnx/MODELS/SURFEX/2_source/SURFEX_TRUNK_4818/trunk/MY_RUN/KTEST/hapex/_S23_PV/SURF_ATM_DIAGNOSTICS.OUT.nc'
...
plt.title('Radiation Balance PV-Ref 2015-07-22 %s UTC' %(hour))
plt.clim(-230,100)
plt.show()
...
cbar = m.colorbar(cs, location='bottom', pad="10%", extend="both")
cbar.set_label(heatflux_units)
plt.title('Ground Heat Flux PV-Ref 2015-07-22 %s UTC' %(hour))
plt.clim(-230,100)
plt.show()
...
cbar = m.colorbar(cs, location='bottom', pad="10%", extend="both")
cbar.set_label(heatflux_units)
plt.title('Sensible Heat Flux PV-Ref 2015-07-22 %s UTC' %(hour))
plt.clim(-230,100)
plt.show()
...
cbar = m.colorbar(cs, location='bottom', pad="10%", extend="both")
cbar.set_label(heatflux_units)
plt.title('Latent Heat Flux PV-Ref 2015-07-22 %s UTC' %(hour))
plt.clim(-230,100)
plt.show()
...
cbar = m.colorbar(cs, location='bottom', pad="10%", extend="both")
cbar.set_label(heatflux_units)
plt.title('Radiation Balance PV-Ref 2015-07-22 %s UTC' %(hour2))
plt.clim(-230,100)
plt.show()
...
cbar = m.colorbar(cs, location='bottom', pad="10%", extend="both")
cbar.set_label(heatflux_units)
plt.title('Ground Heat Flux PV-Ref 2015-07-22 %s UTC' %(hour2))
plt.clim(-230,100)
plt.show()
...
cbar = m.colorbar(cs, location='bottom', pad="10%", extend="both")
cbar.set_label(heatflux_units)
plt.title('Sensible Heat Flux PV-Ref 2015-07-22 %s UTC' %(hour2))
plt.clim(-230,100)
plt.show()
...
cbar = m.colorbar(cs, location='bottom', pad="10%", extend="both")
cbar.set_label(heatflux_units)
plt.title('Latent Heat Flux PV-Ref 2015-07-22 %s UTC' %(hour2))
plt.clim(-230,100)
plt.show()
