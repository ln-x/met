...
cbar.set_label(u"°C")
plt.title('UTCIsun Ref 2015-07-22 18UTC')
plt.clim(25,35)
plt.show()
...
cbar = m.colorbar(cs, location='bottom', pad="10%", extend="both")
cbar.set_label(u"°C")
plt.title('UTCIshade Ref 2015-07-22 18UTC')
plt.clim(25,35)
plt.show()
...
cbar = m.colorbar(cs, location='bottom', pad="10%", extend="both")
cbar.set_label(u"°C")
plt.title('UTCIsun HighAlb-Ref 2015-07-22 18UTC')
plt.clim(-0.5,0.5)
plt.show()
...
cbar = m.colorbar(cs, location='bottom', pad="10%", extend="both")
cbar.set_label(u"°C")
plt.title('UTCIshade HighAlb-Ref 2015-07-22 18UTC')
plt.clim(-0.5,0.5)
plt.show()
