...
for i in range(0,37,1):
 ...
 tair_IS1 = []
 tair_IS1.append(tair1[56:58][:, 83])
 tair_IS1.append(tair1[55:58][:, 84])
 tair_IS1.append(tair1[54:59][:, 85])
 tair_IS1.append(tair1[54:60][:, 86])
 tair_IS1.append(tair1[54:58][:, 87])
 tair_IS1.append(tair1[54:58][:, 88])
 tair_IS2 = []
 tair_IS2.append(tair2[56:58][:, 83])
 tair_IS2.append(tair2[55:58][:, 84])
 tair_IS2.append(tair2[54:59][:, 85])
 tair_IS2.append(tair2[54:60][:, 86])
 tair_IS2.append(tair2[54:58][:, 87])
 tair_IS2.append(tair2[54:58][:, 88])
 tair_IS3 = []
 tair_IS3.append(tair3[56:58][:, 83])
 tair_IS3.append(tair3[55:58][:, 84])
 tair_IS3.append(tair3[54:59][:, 85])
 tair_IS3.append(tair3[54:60][:, 86])
 tair_IS3.append(tair3[54:58][:, 87])
 tair_IS3.append(tair3[54:58][:, 88])
 tair_IS4 = []
 tair_IS4.append(tair4[56:58][:, 83])
 tair_IS4.append(tair4[55:58][:, 84])
 tair_IS4.append(tair4[54:59][:, 85])
 tair_IS4.append(tair4[54:60][:, 86])
 tair_IS4.append(tair4[54:58][:, 87])
 tair_IS4.append(tair4[54:58][:, 88])

 LE_IS = []
 LE_IS.append(LE[56:58][:, 83])
 LE_IS.append(LE[55:58][:, 84])
 LE_IS.append(LE[54:59][:, 85])
 LE_IS.append(LE[54:60][:, 86])
 LE_IS.append(LE[54:58][:, 87])
 LE_IS.append(LE[54:58][:, 88])
 # LE_IS.append(LE[57][:, 89])
 LE_IS1 = []
 LE_IS1.append(LE1[56:58][:, 83])
 LE_IS1.append(LE1[55:58][:, 84])
 LE_IS1.append(LE1[54:59][:, 85])
 LE_IS1.append(LE1[54:60][:, 86])
 LE_IS1.append(LE1[54:58][:, 87])
 LE_IS1.append(LE1[54:58][:, 88])
 LE_IS2 = []
 LE_IS2.append(LE2[56:58][:, 83])
 LE_IS2.append(LE2[55:58][:, 84])
 LE_IS2.append(LE2[54:59][:, 85])
 LE_IS2.append(LE2[54:60][:, 86])
 LE_IS2.append(LE2[54:58][:, 87])
 LE_IS2.append(LE2[54:58][:, 88])
 LE_IS3 = []
 LE_IS3.append(LE3[56:58][:, 83])
 LE_IS3.append(LE3[55:58][:, 84])
 LE_IS3.append(LE3[54:59][:, 85])
 LE_IS3.append(LE3[54:60][:, 86])
 LE_IS3.append(LE3[54:58][:, 87])
 LE_IS3.append(LE3[54:58][:, 88])
 LE_IS4 = []
 LE_IS4.append(LE4[56:58][:, 83])
 LE_IS4.append(LE4[55:58][:, 84])
 LE_IS4.append(LE4[54:59][:, 85])
 LE_IS4.append(LE4[54:60][:, 86])
 LE_IS4.append(LE4[54:58][:, 87])
 LE_IS4.append(LE4[54:58][:, 88])

 SW_IS = []
 SW_IS.append(SW[56:58][:, 83])
 SW_IS.append(SW[55:58][:, 84])
 SW_IS.append(SW[54:59][:, 85])
 SW_IS.append(SW[54:60][:, 86])
 SW_IS.append(SW[54:58][:, 87])
 SW_IS.append(SW[54:58][:, 88])
 # SW_IS.append(SW[57][:, 89])
 SW_IS1 = []
 SW_IS1.append(SW1[56:58][:, 83])
 SW_IS1.append(SW1[55:58][:, 84])
 SW_IS1.append(SW1[54:59][:, 85])
 SW_IS1.append(SW1[54:60][:, 86])
 SW_IS1.append(SW1[54:58][:, 87])
 SW_IS1.append(SW1[54:58][:, 88])
 SW_IS2 = []
 SW_IS2.append(SW2[56:58][:, 83])
 SW_IS2.append(SW2[55:58][:, 84])
 SW_IS2.append(SW2[54:59][:, 85])
 SW_IS2.append(SW2[54:60][:, 86])
 SW_IS2.append(SW2[54:58][:, 87])
 SW_IS2.append(SW2[54:58][:, 88])
 SW_IS3 = []
 SW_IS3.append(SW3[56:58][:, 83])
 SW_IS3.append(SW3[55:58][:, 84])
 SW_IS3.append(SW3[54:59][:, 85])
 SW_IS3.append(SW3[54:60][:, 86])
 SW_IS3.append(SW3[54:58][:, 87])
 SW_IS3.append(SW3[54:58][:, 88])
 SW_IS4 = []
 SW_IS4.append(SW4[56:58][:, 83])
 SW_IS4.append(SW4[55:58][:, 84])
 SW_IS4.append(SW4[54:59][:, 85])
 SW_IS4.append(SW4[54:60][:, 86])
 SW_IS4.append(SW4[54:58][:, 87])
 SW_IS4.append(SW4[54:58][:, 88])

 LW_IS = []
 LW_IS.append(LW[56:58][:, 83])
 LW_IS.append(LW[55:58][:, 84])
 LW_IS.append(LW[54:59][:, 85])
 LW_IS.append(LW[54:60][:, 86])
 LW_IS.append(LW[54:58][:, 87])
 LW_IS.append(LW[54:58][:, 88])
 # LW_IS.append(LW[57][:, 89])
 LW_IS1 = []
 LW_IS1.append(LW1[56:58][:, 83])
 LW_IS1.append(LW1[55:58][:, 84])
 LW_IS1.append(LW1[54:59][:, 85])
 LW_IS1.append(LW1[54:60][:, 86])
 LW_IS1.append(LW1[54:58][:, 87])
 LW_IS1.append(LW1[54:58][:, 88])
 LW_IS2 = []
 LW_IS2.append(LW2[56:58][:, 83])
 LW_IS2.append(LW2[55:58][:, 84])
 LW_IS2.append(LW2[54:59][:, 85])
 LW_IS2.append(LW2[54:60][:, 86])
 LW_IS2.append(LW2[54:58][:, 87])
 LW_IS2.append(LW2[54:58][:, 88])
 LW_IS3 = []
 LW_IS3.append(LW3[56:58][:, 83])
 LW_IS3.append(LW3[55:58][:, 84])
 LW_IS3.append(LW3[54:59][:, 85])
 LW_IS3.append(LW3[54:60][:, 86])
 LW_IS3.append(LW3[54:58][:, 87])
 LW_IS3.append(LW3[54:58][:, 88])
 LW_IS4 = []
 LW_IS4.append(LW4[56:58][:, 83])
 LW_IS4.append(LW4[55:58][:, 84])
 LW_IS4.append(LW4[54:59][:, 85])
 LW_IS4.append(LW4[54:60][:, 86])
 LW_IS4.append(LW4[54:58][:, 87])
 LW_IS4.append(LW4[54:58][:, 88])

 tair_SA = []
 tair_SA.append(tair[60:62][:, 113])
 tair_SA.append(tair[60:65][:, 114])
 tair_SA.append(tair[60:65][:, 115])
 tair_SA.append(tair[60:65][:, 116])
 tair_SA.append(tair[63:65][:, 117])
...
ISdiff_DenseIso = difference(IS1,IS2)
