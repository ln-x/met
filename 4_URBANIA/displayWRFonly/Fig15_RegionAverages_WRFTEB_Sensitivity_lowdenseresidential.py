...
for i in range(0,37,1):
 ...
 tair_IS = []
 tair_IS.append(tair[34:40][:,62:68])
 print tair_IS
 exit()

 tair_IS1 = []
 tair_IS1.append(tair1[34:40][:, 62:68])
 tair_IS2 = []
 tair_IS2.append(tair2[34:40][:, 62:68])
 tair_IS3 = []
 tair_IS3.append(tair3[34:40][:, 62:68])
 tair_IS4 = []
 tair_IS4.append(tair4[34:40][:, 62:68])
 LE_IS = []
 LE_IS.append(LE[34:40][:, 62:68])
 LE_IS1 = []
 LE_IS1.append(LE1[34:40][:, 62:68])
 LE_IS2 = []
 LE_IS2.append(LE2[34:40][:, 62:68])
 LE_IS3 = []
 LE_IS3.append(LE3[34:40][:, 62:68])
 LE_IS4 = []
 LE_IS4.append(LE4[34:40][:, 62:68])
 SW_IS = []
 SW_IS.append(SW[34:40][:, 62:68])
 SW_IS1 = []
 SW_IS1.append(SW1[34:40][:, 62:68])
 SW_IS2 = []
 SW_IS2.append(SW2[34:40][:, 62:68])
 SW_IS3 = []
 SW_IS3.append(SW3[34:40][:, 62:68])
 SW_IS4 = []
 SW_IS4.append(SW4[34:40][:, 62:68])
 LW_IS = []
 LW_IS.append(LW[34:40][:, 62:68])
 LW_IS1 = []
 LW_IS1.append(LW1[34:40][:, 62:68])
 LW_IS2 = []
 LW_IS2.append(LW2[34:40][:, 62:68])
 LW_IS3 = []
 LW_IS3.append(LW3[34:40][:, 62:68])
 LW_IS4 = []
 LW_IS4.append(LW4[34:40][:, 62:68])
