...
tair_max1 = tair[78:102].max(axis=0)
tair_max2 = tair[102:126].max(axis=0)
tair_max3 = tair[174:198].max(axis=0)
tair_max = np.array([tair_max1,tair_max2,tair_max3])
...
tair1_max1 = tair1[78:102].max(axis=0)  #9.8.2015
tair1_max2 = tair1[102:126].max(axis=0) #10.8.2015
tair1_max3 = tair1[174:198].max(axis=0) #13.8.2015
tair1_max = np.array([tair1_max1,tair1_max2,tair1_max3])
tair1_max = tair1_max.mean(axis=0)

tair2_max1 = tair2[78:102].max(axis=0)
tair2_max2 = tair2[102:126].max(axis=0)
tair2_max3 = tair2[174:198].max(axis=0)
tair2_max = np.array([tair2_max1,tair2_max2,tair2_max3])
...
fig2.suptitle("mean daily maxima, averaged over regions for 9,10,13 Aug 2015")
