...
tair_max3 = tair[150:174].max(axis=0)
tair_max4 = tair[174:198].max(axis=0)
...
tair1_max3 = tair1[150:174].max(axis=0) #12.8.2015
tair1_max4 = tair1[174:198].max(axis=0) #13.8.2015
...
tair2_max3 = tair2[150:174].max(axis=0)
tair2_max4 = tair2[174:198].max(axis=0)
...
fig2.suptitle("mean daily maxima, averaged over regions for 9,10,12,13 Aug 2015")
