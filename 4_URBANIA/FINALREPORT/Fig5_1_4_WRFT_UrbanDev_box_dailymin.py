...
tair_max3 = tair[174:198].min(axis=0)
...
tair1_max1 = tair1[78:102].min(axis=0)
tair1_max2 = tair1[102:126].min(axis=0)
tair1_max3 = tair1[174:198].min(axis=0)
...
tair2_max3 = tair2[174:198].min(axis=0)
...
fig2.suptitle("mean daily minima, averaged over regions for 9,10,13 Aug 2015")
