...
fig = plt.figure()
plt.title('thermische Leitfaehigkeit Fassade' )
#plt.title('24.-25.8.2016, dichtes Wohn(misch)gebiet, Passivhausstandard, Vgl. Albedo')
plt.plot(x, tempcanyon[-288:], linestyle='-', color = 'red', label = "Bestand: 1.7 [W/mK]")# locker bebautes Wohn(misch)gebiet")
plt.plot(x, tempcanyon_2[-288:], linestyle='-', color = 'black', label = "saniert:   0.1 [W/mK]")# - Passivfenster")# Gartenstadt")
