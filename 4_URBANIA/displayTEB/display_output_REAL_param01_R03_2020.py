...
scenario1 = "R03"
scenario2 = "R03_2020_BVp_Kp"
scenario3 = "R03_2020_BVpp_Kp"
scenario4 = "R03_2020_BVp_Km"
scenario5 = "R03_2020_BVpp_Km"
...
fig = plt.figure()
#plt.title('temperature - canyon, dichtes Wohn(misch)gebiet' )
plt.plot(x[:144], tempcanyon[:144], linestyle='-', color = 'black', label = "STQ")# locker bebautes Wohn(misch)gebiet")
plt.plot(x[:144], tempcanyon_2[:144], linestyle='-', color = 'blue', label = "2020 BV+, K+")# Gartenstadt")
plt.plot(x[:144], tempcanyon_3[:144], linestyle='-', color = 'green', label = "2020 BV++, K+")# dichtes Wohn(misch)gebiet")
plt.plot(x[:144], tempcanyon_4[:144], linestyle='-', color = 'violet', label = "2020 BV+, K-")# grossvolumiger solitaerer Wohn(misch)bau")
plt.plot(x[:144], tempcanyon_5[:144], linestyle='-', color = 'red', label = "2020 BV++, K-")# Buero- und Verwaltungsviertel")
