...
startdate = dt.date(2011,10,3)
enddate = dt.date(2011,10,6) 
starttime = dt.time(13,30,0)
endtime = dt.time(14,0,0)
#print startdate, enddate, starttime, endtime

csv_reader = csv.reader(open('JHS_Albedo_20111005_20130102_a.csv'))
...
ax.plot(x,gs,color='orange',marker = '.', lw=0.5, label='gs') 
ax.plot(x,r3,color='red',lw=0.5, label='r3')
ax.plot(x,a3,color='blue',lw=0.5, label='a3')
