...
csv_reader = csv.reader(open('csv_input/JHS_lt1-19_20110810-1007.csv'))
...
ax.plot(x,y11,color='brown',lw=0.5, label='10')
ax.plot(x,y12,color='brown',lw=0.5, label='11')
ax.plot(x,y13,color='brown',lw=0.5, label='12')
ax.plot(x,y14,color='brown',lw=0.5, label='13')
ax.plot(x,y15,color='brown',lw=0.5, label='14')
ax.plot(x,y16,color='brown',lw=0.5, label='15')
ax.plot(x,y17,color='brown',lw=0.5, label='16')
ax.plot(x,y18,color='brown',lw=0.5, label='17')
