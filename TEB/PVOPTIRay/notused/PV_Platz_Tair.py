...
PVfile = "/home/lnx/MODELS/SURFEX/2_source/SURFEX_TRUNK_4818/trunk/MY_RUN/KTEST/lnx/7_Platz_A_N_PV100/2017_242/TCANYON.TXT"
...
plt.title(u"Einfluss PV")
ax.plot(PVvalues, label="Asphalt + PV")
ax.plot(STQvalues, label="Asphalt + Putz")#, color="red")
#ax.plot(S4values, label="Beton + Putz")#, color="blue")
