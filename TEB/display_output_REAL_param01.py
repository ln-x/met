...
plt.plot(x, tempcanyon_4, linestyle='-', color = 'green', label = "unsealed fraction 0.28 > 0.16") #datalabel[8]) #Canyon, data[8]
#plt.plot(x, tempcanyon_2, linestyle='-', color = 'red', label = "increased isolation")# 1.7/1.4 > 0.1
