...
plt.plot(x, data6[14][-288:], linestyle='-', color = 'red', label = "Ost-West")
plt.plot(x, data6[15][-288:], linestyle='--', color = 'red')#, label = "Ost-West")
plt.plot(x, data7[14][-288:], linestyle='-', color = 'blue', label = "Nord-Sued")
plt.plot(x, data7[15][-288:], linestyle='--', color = 'blue')#, label = "Nord-Sued")
plt.plot(x, data8[14][-288:], linestyle='-', color = 'green', label = "Suedwest-Nordost")
plt.plot(x, data8[15][-288:], linestyle='--', color = 'green')#, label = "SW-NO")
plt.plot(x, data9[14][-288:], linestyle='-', color = 'orange', label = "Nordwest-Suedost")
