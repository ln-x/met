...
plt.plot(x, tempcanyon_3[-144:], linestyle='-', color = 'red', label = "building area +0.25")
plt.plot(x, tempcanyon_4[-144:], linestyle='-', color = 'blue', label = "building height +5m")
plt.plot(x, tempcanyon_5[-144:], linestyle='-', color = 'green', label = "vertic./horiz.area 2.1 -> 1.1")
