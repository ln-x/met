...
S200wo_pv70 = "/home/lnx/MODELS/SURFEX/2_source/SURFEX_TRUNK_4818/trunk/MY_RUN/KTEST/lnx/210_Kreuzung_A_PV70/2017_170171WO/TCANYON.TXT"
...
S200wopv70values = loadfile(S200wo_pv70)
...
#STQ
ax1.plot(timelist[73:234],S200WOvalues[73:234], label=r"$\alpha_{G}$:0,13;$\alpha_{W}$:0,20;$\alpha_{R}$:0,14 'STQ'", color="orange")#,linestyle="dashed")
...
#Heller Boden
ax1.plot(timelist[73:234],S201WOvalues[73:234], label=r"$\alpha_{G}$:0,56;$\alpha_{W}$:0,20;$\alpha_{R}$:0,14 'heller Boden'", color="red")#,linestyle="dashed")
...
#Weißer Canyon
#ax1.plot(timelist[73:234],S205WOvalues[73:234], label=r"$\alpha_{G}$:0,80;$\alpha_{W}$:0.80;$\alpha_{R}$:0,14 'weisser Canyon'", color="violet")
#ax1.plot(timelist,S205NSvalues, color="violet",linestyle=":")
#Weißes Dach
ax1.plot(timelist[73:234],S200WOwhiteroofvalues[73:234], label=r"$\alpha_{G}$:0,13;$\alpha_{W}$:0.20;$\alpha_{R}$:0,80 'weisses Dach'", color="green")#,linestyle="dashed")
#ax1.plot(timelist,S200NSwhiteroofvalues, color="green",linestyle=":")
#Heller Boden, Weißes Dach
#ax1.plot(timelist[73:234],S200WOhorwhitevalues[73:234], label=r"$\alpha_{G}$:0,56;$\alpha_{W}$:0.13;$\alpha_{R}$;0,80 'helle Horizontale'", color="turquoise")
#ax1.plot(timelist,S200NShorwhitevalues, color="turquoise",linestyle=":")
#Alles Weiß
#ax1.plot(timelist[73:234],S200WOallwhitevalues[73:234], label=r"$\alpha_{G}$:0,80;$\alpha_{W}$:0,80;$\alpha_{R}$:0,80 'alles Weiss'", color="blue" )
#ax1.plot(timelist,S200NSallwhitevalues, color="blue",linestyle=":")
#PV Dach
ax1.plot(timelist[73:232],S200WOpvroofvalues[73:232], label=r"PV Dach, $\eta$=0.2", color="black")#,linestyle="dashed")
#ax1.plot(timelist,S200NSpvroofvalues, color="black",linestyle=":")
ax1.plot(timelist[73:230],S200wopv70values[73:230], label=r"PV Fassade", color="grey")
