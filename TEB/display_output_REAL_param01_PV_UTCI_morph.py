...
fig = plt.figure()
plt.title('urban morphology' )
#plt.title('street orientation' )
#plt.plot(x, data[14], linestyle='-', color = 'yellow', label = "STQ")
plt.plot(x, data2[14][-288:], linestyle='-', color = 'green', label = "STQ")
plt.plot(x, data2[15][-288:], linestyle='--', color = 'green')#, label = "STQ")
...
#plt.plot(x, data6[14][-288:], linestyle='-', color = 'violet', label = "O-W")
#plt.plot(x, data6[15][-288:], linestyle='--', color = 'violet')#, label = "Ost-West")
#plt.plot(x, data7[14][-288:], linestyle='-', color = 'red', label = "N-S")
#plt.plot(x, data7[15][-288:], linestyle='--', color = 'red')#, label = "Nord-Sued")
#plt.plot(x, data8[14][-288:], linestyle='-', color = 'pink', label = "SW-NO")
#plt.plot(x, data8[15][-288:], linestyle='-', color = 'pink')#, label = "SW-NO")
#plt.plot(x, data8[14][-288:], linestyle='--', color = 'orange', label = "NW-SO")
#plt.plot(x, data8[15][-288:], linestyle='--', color = 'orange')#, label = "NW-SO")
