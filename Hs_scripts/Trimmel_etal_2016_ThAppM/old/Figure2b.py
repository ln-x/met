...
BC_2013_0 = pd.read_csv('/home/lnx/PycharmProjects/HS/298_P500_STQ_2013_p/inputfiles/Boundary_Conditions_P_B4.csv', sep=',', parse_dates=['DateTime'])
stats= BC_2013_0.describe()
print 'BC_2013=', stats
BC_2013 = BC_2013_0.set_index('DateTime')
BC_2013_WT = BC_2013['BC_Temp_C'] #BC_Inflow_cms,BC_Temp_C
BC_2013_WT = np.array(BC_2013_WT.values)
print BC_2013_WT
BC_2030_0 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden/Pinka/2016-2045/Max/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
stats= BC_2030_0.describe()
print 'BC_2030_max=', stats
BC_2050_0 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden/Pinka/2036-2065/Max/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
stats= BC_2050_0.describe()
print 'BC_2050_max=', stats
BC_2050_0 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden/Pinka/2071-2100/Max/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
stats= BC_2050_0.describe()
print 'BC_2050_max=', stats

fs = 10  # fontsize

fig, axes = plt.subplots(nrows=3, ncols=4, sharey='row') #, figsize=(6, 6))
...
axes[2,0].boxplot(BC_2013_WT)
#axes[2,0].set_title('2013', fontsize=fs)
axes[2,0].set_ylabel('water temperature [degC]', fontsize=fs)
axes[2,0].set(xticklabels=(' '))

fig.savefig('/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Output_analysis/2015Paper/Figure2b_inklBC.tiff')
plt.show()