...
WT_5a_2030 = WT_5a_2030_V0.ix[240:].drop(['Datetime'],axis=1)
...
WT_5a_2030 = WT_5a_2030_V100.ix[240:].drop(['Datetime'],axis=1)
...
WT_20a_2030 = np.array(WT_max_2030)
...
WT_20a_2030 = WT_20a_2030.ix[240:].drop(['Datetime'],axis=1)
WT_20a_2030_V0 = np.array(WT_max_2030_V0)
...
WT_20a_2030 = WT_20a_2030.ix[240:].drop(['Datetime'],axis=1)
WT_20a_2030_V100 = np.array(WT_20a_2030_V100)
...
WT_20ax_2050 = np.array(WT_20a_2050)
...
WT_20a_2050_V0 = np.array(WT_20a_2050_V0)
...
WT_20a_2050_V100 = np.array(WT_20a_2050_V100)
...
WT_5a_2085_V100 = WT_5a_2085.ix[240:].drop(['Datetime'],axis=1)   #only last 5days, drop "Datetime" column
...
WT_20a_2030 = WT_20a_2030.ix[240:].drop(['Datetime'],axis=1)   #only last 5days, drop "Datetime" column
WT_20a_2085 = np.array(WT_20a_2085)
...
WT_20a_2030 = WT_20a_2030.ix[240:].drop(['Datetime'],axis=1)   #only last 5days, drop "Datetime" column
WT_20a_2085_V0 = np.array(WT_20a_2085_V0)
...
WT_20a_2030 = WT_20a_2030.ix[240:].drop(['Datetime'],axis=1)   #only last 5days, drop "Datetime" column
WT_20a_2085_V100 = np.array(WT_20ax_2085_V100)
