...
WT_max_2030 = WT_max_2030.mean()
#WT_2030 = pd.merge(WT_1a_2030, WT_5a_2030) #doesnt work - because of Series?
WT_2030 = pd.concat([WT_1a_2030, WT_5a_2030,WT_max_2030],axis=1)
stats= WT_2030.describe()
print '2030=', stats
WT_2030 = np.array(WT_2030.values)
#print WT_2030
...
WT_1a_2030_V0 = WT_1a_2030_V0.mean()
...
WT_5a_2030_V0 = WT_5a_2030_V0.mean()
...
WT_max_2030_V0 = WT_max_2030_V0.mean()
WT_2030_V0 = pd.concat([WT_1a_2030_V0, WT_5a_2030_V0,WT_max_2030_V0],axis=1)
stats= WT_2030_V0.describe()
print '2030_V0=', stats
WT_2030_V0 = np.array(WT_2030_V0.values)
...
WT_1a_2030_V100 = WT_1a_2030_V100.mean()
...
WT_5a_2030_V100 = WT_5a_2030_V100.mean()
...
WT_max_2030_V100 = WT_max_2030_V100.mean()
WT_2030_V100 = pd.concat([WT_1a_2030_V100, WT_5a_2030_V100,WT_max_2030_V100],axis=1)
stats= WT_2030_V100.describe()
print '2030_V100=', stats
WT_2030_V100 = np.array(WT_2030_V100.values)
...
WT_max_2050 = WT_max_2050.mean()
WT_2050 = pd.concat([WT_1a_2050, WT_5a_2050,WT_max_2050],axis=1)
stats= WT_2050.describe()
print '2050=', stats
WT_2050 = np.array(WT_2050.values)
...
WT_1a_2050_V0 = WT_1a_2050_V0.mean()
...
WT_5a_2050_V0 = WT_5a_2050_V0.mean()
...
WT_max_2050_V0 = WT_max_2050_V0.mean()
WT_2050_V0 = pd.concat([WT_1a_2050_V0, WT_5a_2050_V0,WT_max_2050_V0],axis=1)
stats= WT_2050_V0.describe()
print '2050_V0=', stats
WT_2050_V0 = np.array(WT_2050_V0.values)
...
WT_1a_2050_V100 = WT_1a_2050_V100.mean()
...
WT_5a_2050_V100 = WT_5a_2050_V100.mean()
...
WT_max_2050_V100 = WT_max_2050_V100.mean()
WT_2050_V100 = pd.concat([WT_1a_2050_V100, WT_5a_2050_V100,WT_max_2050_V100],axis=1)
stats= WT_2050_V100.describe()
print '2050_V100=', stats
WT_2050_V100 = np.array(WT_2050_V100.values)
...
WT_max_2085 = WT_max_2085.mean()
WT_2085 = pd.concat([WT_1a_2085, WT_5a_2085,WT_max_2085],axis=1)
stats= WT_2085.describe()
print '2085=', stats
WT_2085 = np.array(WT_2085.values)
...
WT_1a_2085_V0 = WT_1a_2085_V0.mean()
...
WT_5a_2085_V0 = WT_5a_2085_V0.mean()
...
WT_max_2085_V0 = WT_max_2085_V0.mean()
WT_2085_V0 = pd.concat([WT_1a_2085_V0, WT_5a_2085_V0,WT_max_2085_V0],axis=1)
stats= WT_2085_V0.describe()
print '2085_V0=', stats

WT_2085_V0 = np.array(WT_2085_V0.values)
...
WT_1a_2085_V100 = WT_1a_2085_V100.mean()
...
WT_5a_2085_V100 = WT_5a_2085_V100.mean()
...
WT_max_2085_V100 = WT_max_2085_V100.mean()
WT_2085_V100 = pd.concat([WT_1a_2085_V100, WT_5a_2085_V100,WT_max_2085_V100],axis=1)
stats= WT_2085_V100.describe()
print '2085_V100=', stats
WT_2085_V100 = np.array(WT_2085_V100.values)
...
fig.savefig('/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Output_analysis/2015Paper/Figure3_mean.tiff')
plt.show()

print 'WT_2030=', WT_2030.describe()
