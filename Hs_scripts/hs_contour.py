...
subplot(122)
hist(listeddata)
plt.title('Convection[W/m2], 1Jul-29Aug2013, Lafnitz,(origConv,masstransfer)')
...
fig.savefig('/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Output_analysis/2014Paper/origC_m_Conv_statistics_L_new.png')
...
plt.title('Convection [W/m2], 1 Jul  - 29 Aug 2013, Lafnitz, (origConv, masstransfer)')
plt.xlabel('distance from upstream model boundary [km]')
plt.ylabel('time[h]')
#plt.legend()
fig.savefig('/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Output_analysis/2014Paper/origC_m_Conv_contour_L_new.png')
fig.savefig('/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Output_analysis/2014Paper/origC_m_Conv_contour_L_new.svg')
