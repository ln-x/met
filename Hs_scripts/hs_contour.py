...
filename = "/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Simulations_Archive/049_submittedversion/outputfiles/Heat_Conv.txt"
...
subplot(122)
hist(listeddata)
plt.title('Convection[W/m2], 1Jul-29Aug2013, Pinka,(submitted, origC, penman)')
...
fig.savefig('/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Output_analysis/2014Paper/submitted_Conv_statistics.png')
...
plt.ylabel('time[h]')
#plt.legend()
fig.savefig('/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Output_analysis/2014Paper/submitted_Conv_contour.png')
fig.savefig('/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Output_analysis/2014Paper/submitted_Conv_contour.eps')
