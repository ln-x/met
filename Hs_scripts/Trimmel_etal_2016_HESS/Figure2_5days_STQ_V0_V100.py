...
ax.plot(Rkm, VTS_V0, color='black', linestyle='dashed', lw=0.5, label='V0')
ax.plot(Rkm, VTS, color='black', lw=0.5, label='STQ')
ax.plot(Rkm, VTS_V100, color='black', linestyle='solid', lw=1.0, label='V100')
...
ax.plot(Rkm, Sw_V100_mean, color='orange', lw=1.0, label="Q_sw, V100")
...
ax.plot(Rkm, Lw_V100_mean, color='violet', lw=1.0, label="Q_lw, V100")
...
ax.plot(Rkm, Ev_V100_mean, color='#1b9e77', lw=1.0, linestyle='solid', label="LE, V100")
...
ax.plot(Rkm, Cv_V100_mean, color='#d95f02', lw=1.0, label="H, V100")
