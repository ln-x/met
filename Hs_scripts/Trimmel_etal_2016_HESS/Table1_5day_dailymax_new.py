...
C_2013_max5days = C_2013_max5days.resample('D', how='max')
...
C_1a_2030_max5days = C_1a_2030.ix[240:].resample('D', how='max') #last five days
...
C_5a_2030_max5days = C_5a_2030.ix[240:].resample('D', how='max')
...
C_20a_2030_max5days = C_20a_2030.ix[240:].resample('D', how='max')
...
C_max_2030_max5days = C_max_2030.ix[240:].resample('D', how='max')
...
C_1a_2050_max5days = C_1a_2050.ix[240:].resample('D', how='max') #last five days
...
C_5a_2050_max5days = C_5a_2050.ix[240:].resample('D', how='max')
...
C_20a_2050_max5days = C_20a_2050.ix[240:].resample('D', how='max')
...
C_max_2050_max5days = C_max_2050.ix[240:].resample('D', how='max')
...
C_1a_2085_max5days = C_1a_2085.ix[240:].resample('D', how='max')  #last five days
...
C_5a_2085_max5days = C_5a_2085.ix[240:].resample('D', how='max')
...
C_20a_2085_max5days = C_20a_2085.ix[240:].resample('D', how='max')
...
C_max_2085_max5days = C_max_2085.ix[240:].resample('D', how='max')
...
#stats= BC_2013_new['61'].describe()
print 'max5days\nBC_2013=', stats

BC_2030 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden_new/Pinka/2016-2045/1jaehrl/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
BC_2030_max5days = BC_2030.ix[240:].resample('D', how='max')
print 'BC_2030 1a=', BC_2030_max5days.describe()
BC_2030 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden_new/Pinka/2016-2045/5jaehrl/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
BC_2030_max5days = BC_2030.ix[240:].resample('D', how='max')
print 'BC_2030 5a=', BC_2030_max5days.describe()
BC_2030 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden_new/Pinka/2016-2045/20jaehrl/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
BC_2030_max5days = BC_2030.ix[240:].resample('D', how='max')
print 'BC_2030 20a=', BC_2030_max5days.describe()
BC_2030 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden_new/Pinka/2016-2045/Max/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
BC_2030_max5days = BC_2030.ix[240:].resample('D', how='max')
stats = BC_2030_max5days.describe()
print 'BC_2030 max=', stats


BC_2050 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden_new/Pinka/2036-2065/1jaehrl/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
BC_2050_max5days = BC_2050.ix[240:].resample('D', how='max')
print 'BC_2050 1a=', BC_2050_max5days.describe()
BC_2050 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden_new/Pinka/2036-2065/5jaehrl/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
BC_2050_max5days = BC_2050.ix[240:].resample('D', how='max')
print 'BC_2050 5a=', BC_2050_max5days.describe()
BC_2050 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden_new/Pinka/2036-2065/20jaehrl/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
BC_2050_max5days = BC_2050.ix[240:].resample('D', how='max')
print 'BC_2050 20a=', BC_2050_max5days.describe()
BC_2050 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden_new/Pinka/2036-2065/Max/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
BC_2050_max5days = BC_2050.ix[240:].resample('D', how='max')
stats= BC_2050_max5days.describe()
print 'BC_2050 max=', stats

BC_2085 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden_new/Pinka/2071-2100/1jaehrl/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
BC_2085_max5days = BC_2085.ix[240:].resample('D', how='max')
print 'BC_2030 1a=', BC_2085_max5days.describe()
BC_2085 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden_new/Pinka/2071-2100/5jaehrl/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
BC_2085_max5days = BC_2085.ix[240:].resample('D', how='max')
print 'BC_2030 5a=', BC_2085_max5days.describe()
BC_2085 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden_new/Pinka/2071-2100/20jaehrl/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
BC_2085_max5days = BC_2085.ix[240:].resample('D', how='max')
print 'BC_2030 20a=', BC_2085_max5days.describe()
BC_2085 = pd.read_csv('/home/lnx/2_Documents/_BioClic/_Simulationen/ClimateSzenarios/Episoden_new/Pinka/2071-2100/Max/MLF/Boundary_Conditions.csv', sep=',', parse_dates=['DateTime'])
BC_2085_max5days = BC_2085.ix[240:].resample('D', how='max')
