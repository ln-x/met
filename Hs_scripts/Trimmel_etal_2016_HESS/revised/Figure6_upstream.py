...
V0_now_WT = "WT = %1.2f degC" %WT_20a_1995_V0['80.000'][-120:].mean()
V0_now_Ev = "evap = %1.2f W m-2" %WT_20a_1995_Ev_V0['80.000'][-120:].mean()
V0_now_evap = "ev_sum = %1.2f mm" %WT_20a_1995_ER_V0['80.000'][-120:].sum()
#V0_now_evap = "ev_sum = %1.2f mm" %WT_20a_1995_ER_V0['80.000'][-120:].sum()
...
V70_now_balance = WT_20a_1995_Sw_V70['80.000'][-120:].mean() + WT_20a_1995_Lw_V70['80.000'][-120:].mean()+ WT_20a_1995_Cv_V70['80.000'][-120:].mean()+ \
             WT_20a_1995_Ev_V70['80.000'][-120:].mean()+ WT_20a_1995_Cd_V70['80.000'][-120:].mean()
...
V100_now_balance = WT_20a_1995_Sw_V100['80.000'][-120:].mean() + WT_20a_1995_Lw_V100['80.000'][-120:].mean()+ WT_20a_1995_Cv_V100['80.000'][-120:].mean()+ \
             WT_20a_1995_Ev_V100['80.000'][-120:].mean()+ WT_20a_1995_Cd_V100['80.000'][-120:].mean()
...
V70_balance = WT_20a_2085_Sw_V70['80.000'][-120:].mean() + WT_20a_2085_Lw_V70['80.000'][-120:].mean()+ WT_20a_2085_Cv_V70['80.000'][-120:].mean()+ \
             WT_20a_2085_Ev_V70['80.000'][-120:].mean()+ WT_20a_2085_Cd_V70['80.000'][-120:].mean()
V70_balance_s = "bal = %1.2f W m-2" %V70_balance
V70_WT = "WT = %1.2f,%1.2f degC" %(WT_20a_2085_V70['80.000'][-120:].mean(),WT_20a_2085_V70['80.000'][-120:].max())
...
V70_085MLF_balance = WT_20a_2085_Sw_V70_085MLF['80.000'][-120:].mean() + WT_20a_2085_Lw_V70_085MLF['80.000'][-120:].mean()+ WT_20a_2085_Cv_V70_085MLF['80.000'][-120:].mean()+ \
             WT_20a_2085_Ev_V70_085MLF['80.000'][-120:].mean()+ WT_20a_2085_Cd_V70_085MLF['80.000'][-120:].mean()
V70_085MLF_balance_s = "bal = %1.2f W m-2" %V70_085MLF_balance
V70_085MLF_WT = "WT = %1.2f, %1.2f degC" %(WT_20a_2085_V70_085MLF['80.000'][-120:].mean(), WT_20a_2085_V70_085MLF['80.000'][-120:].max())
...
#Statistics
print "2085/20a,V70,MLF - max", WT_20a_2085_V70['80.000'][-24:].max() - WT_20a_2085_V100['80.000'][-24:].max()
print "2085/20a,V70,MLF - min", WT_20a_2085_V70['80.000'][-24:].min() - WT_20a_2085_V100['80.000'][-24:].min()

print "1995/20a,V70,MLF - max", WT_20a_1995_V70['80.000'][-24:].max() - WT_20a_1995_V100['80.000'][-24:].max()
print "1995/20a,V70,MLF - min", WT_20a_1995_V70['80.000'][-24:].min() - WT_20a_1995_V100['80.000'][-24:].min()

print "2085/20a,V100,MLF - Convection", WT_20a_2085_Cv_V100['80.000'][-24:].mean()
print "2085/20a,V100,MLF - Evaporation", WT_20a_2085_Ev_V100['80.000'][-24:].mean()
print "2085/20a,V100,MLF - Longwave", WT_20a_2085_Lw_V100['80.000'][-24:].mean()
print "2085/20a,V100,MLF - Shortwave", WT_20a_2085_Sw_V100['80.000'][-24:].mean()

#print "2085/20a,V70-V100,MLF - Convection", WT_20a_2085_Cv_V70['80.000'].mean()- WT_20a_2085_Cv_V100['80.000'].mean()
#print "2085/20a,V70-V100,MLF - Evaporation", WT_20a_2085_Ev_V70['80.000'].mean()- WT_20a_2085_Ev_V100['80.000'].mean()
#print "2085/20a,V70-V100,MLF - Longwave", WT_20a_2085_Lw_V70['80.000'].mean()- WT_20a_2085_Lw_V100['80.000'].mean()
#print "2085/20a,V70-V100,MLF - Shortwave", WT_20a_2085_Sw_V70['80.000'].mean()- WT_20a_2085_Sw_V100['80.000'].mean()

##DFM 39: last day:
#2085/20a,V70-V100,MLF - Convection 0.20815
#2085/20a,V70-V100,MLF - Evaporation -10.3603541667
#2085/20a,V70-V100,MLF - Longwave 1.50009166667
#2085/20a,V70-V100,MLF - Shortwave 7.49681666667
##DFM 39: full episode
#2085/20a,V70-V100,MLF - Convection -0.150694444444
#2085/20a,V70-V100,MLF - Evaporation -7.92505194444
#2085/20a,V70-V100,MLF - Longwave 1.26306583333
#2085/20a,V70-V100,MLF - Shortwave 6.58137361111
...
ax.plot(WT_20a_1995_Sw_V0['80.000'][-24:], linestyle='-', color = 'yellow', label='Sw')
ax.plot(WT_20a_1995_Lw_V0['80.000'][-24:], linestyle='-', color = 'orange', label='Lw')
ax.plot(WT_20a_1995_Cv_V0['80.000'][-24:], linestyle='-', color = 'red', label='Cv')
ax.plot(WT_20a_1995_Ev_V0['80.000'][-24:], linestyle='-', color = 'green', label='Ev')
ax.plot(WT_20a_1995_Cd_V0['80.000'][-24:], linestyle='-', color = 'violet', label='Cd')
plt.setp(ax.get_xticklabels(), visible=False)
ax.set_ylim([-750,750])
ax.set_ylabel('[W m-2]', fontsize='large')
ax2 = ax.twinx()
ax2.plot(WT_20a_1995_V0['80.000'][-24:], linestyle='-', color = 'blue', label='WT')
...
ax.plot(WT_20a_1995_Sw_V70['80.000'][-24:], linestyle='-', color = 'yellow', label='Sw')
ax.plot(WT_20a_1995_Lw_V70['80.000'][-24:], linestyle='-', color = 'orange', label='Lw')
ax.plot(WT_20a_1995_Cv_V70['80.000'][-24:], linestyle='-', color = 'red', label='Cv')
ax.plot(WT_20a_1995_Ev_V70['80.000'][-24:], linestyle='-', color = 'green', label='Ev')
ax.plot(WT_20a_1995_Cd_V70['80.000'][-24:], linestyle='-', color = 'violet', label='Cd')
plt.setp(ax.get_xticklabels(), visible=False)
ax.set_ylim([-750,750])
ax2 = ax.twinx()
ax2.plot(WT_20a_1995_V70['80.000'][-24:], linestyle='-', color = 'blue', label='WT')
plt.setp(ax2.get_yticklabels(), visible=False)
...
ax.plot(WT_20a_1995_Sw_V100['80.000'][-24:], linestyle='-', color = 'yellow', label='Sw')
ax.plot(WT_20a_1995_Lw_V100['80.000'][-24:], linestyle='-', color = 'orange', label='Lw')
ax.plot(WT_20a_1995_Cv_V100['80.000'][-24:], linestyle='-', color = 'red', label='Cv')
ax.plot(WT_20a_1995_Ev_V100['80.000'][-24:], linestyle='-', color = 'green', label='Ev')
ax.plot(WT_20a_1995_Cd_V100['80.000'][-24:], linestyle='-', color = 'violet', label='Cd')
plt.setp(ax.get_xticklabels(), visible=False)
ax.set_ylim([-750,750])
ax2 = ax.twinx()
ax2.plot(WT_20a_1995_V100['80.000'][-24:], linestyle='-', color = 'blue', label='WT')
ax2.set_ylim([18,29])
...
ax.set_ylim([-750,750])
ax2 = ax.twinx()
ax2.plot(WT_20a_2085_V70['80.000'][-24:], linestyle='-', color = 'blue', label='WT')
ax2.set_ylim([18,29])
plt.setp(ax2.get_yticklabels(), visible=False)
...
ax.set_ylim([-750,750])
ax2 = ax.twinx()
ax2.plot(WT_20a_2085_V70_085MLF['80.000'][-24:], linestyle='-', color = 'blue', label='WT')
ax2.set_ylim([18,29])
plt.setp(ax2.get_yticklabels(), visible=False)
plt.setp(ax.get_yticklabels(), visible=False)
...
#ax.legend(loc='upper center', bbox_to_anchor=(-0.8, -0.5),
