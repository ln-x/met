...
m3 = [i[7] for i in mdata] #Messdaten Sinnersdorf
...
ax.plot(date_time, x1, color='red', lw=0.2)      #HB
ax.plot(date_time, x2, color='darkred', lw=0.2)  #TB
ax.plot(date_time, x3, color='violet', lw=0.2)   #SD
ax.plot(date_time, x4, color='darkblue', lw=0.2) #RD
ax.plot(date_time, m1, color='red', lw=0.7)
ax.plot(date_time, m2, color='darkred', lw=0.7)
ax.plot(date_time, m3, color='violet', lw=0.7)
ax.plot(date_time, m4, color='darkblue', lw=0.7)
