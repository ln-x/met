...
fig = plt.figure()
plt.plot(Bilanz['51.000'], linestyle='-', color = 'black', label='Bal')
#plt.plot(Bilanz_mt['51.000'], linestyle='--', color = 'black', label='Bal_mt')
plt.plot(Lw['51.000'], linestyle='-', color = 'orange', label='Lw')
plt.plot(Sw['51.000'], linestyle='-', color = 'yellow', label='Sw')
plt.plot(Cv['51.000'], linestyle='-', color = 'red', label='Cv')
#plt.plot(Cv_mt['61.000'], linestyle='--', color = 'red', label='Cv_mt')
plt.plot(Ev['51.000'], linestyle='-', color = 'green', label='Ev')
#plt.plot(Ev_mt['61.000'], linestyle='--', color = 'green', linewidth=2.0, label='Ev_mt')
plt.plot(Cd['51.000'], linestyle='-', color = 'violet', label='Cd')
...
fig.savefig('/home/lnx/2_Documents/_BioClic/_Simulationen/HS_Output_analysis/2015Paper/Heatfluxes_DFM51.tiff')
