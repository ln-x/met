...
csv_reader = csv.reader(open('csv_input/wege_Table1_20111105_1107.csv'))
...
ax.plot(x,y17,color='black',lw=0.5, label='17')
ax.plot(x,y18,color='black',lw=0.5, label='18')
ax.plot(x,y19,color='black',lw=0.5, label='19')
ax.plot(x,y20,color='black',lw=0.5, label='20')
